...
<% if $Icon=='AngiesList' && $SiteConfig.AngiesListURL %>
	<li>
		<a href="$SiteConfig.AngiesListURL" id="icon_an" target="_blank">
			<svg alt="Find us on Angie's List" version="1.1" class="social-icon" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 893.6 614" xml:space="preserve">
				<path class="fill" d="M885.8,150.9C860.1,60.9,779.4,0,685.8,0H208.3c-13.7,0-27.2,1.4-40.7,3.9C59.5,24.3-15.5,129.7,2.8,238.4c14.4,84.3,64.1,139.9,145.3,166.9c24.4,8.1,49.7,9.4,75.1,8.7c3.1-0.1,4.8,0.7,6.2,3.6c26.3,52.1,52.7,104.2,79.1,156.3c6.7,13.2,13.4,26.4,20.4,40.1c1.2-2.4,2.2-4.1,3-5.8c30.8-62.9,61.6-125.8,92.2-188.8c2.1-4.3,4.5-5.4,9-5.4c83.8,0.1,167.7,0.1,251.5,0.1c14,0,27.9-1.3,41.7-3.9C844.3,387.8,918.9,266.6,885.8,150.9z M701.9,320.6c-5.3,0.7-10.6,1-15.9,1c-103,0.1-206,0.1-309-0.1c-4.5,0-6.2,1.4-7.7,5.5c-12.8,35.5-25.8,71-38.7,106.5c-0.4,1.4-0.9,2.7-1.7,4.6c0,0,0,0,0,0l0,0c0,0,0,0,0,0c-4.6-12.6-9-24.6-13.4-36.6c-9.1-25-18.3-50-27.2-75.1c-1.3-3.5-2.9-4.8-6.7-4.8c-24.2,0.2-48.3,0.1-72.5,0.1c-55.8,0-101.9-36.9-114.1-91.3c-14-62.1,29.9-126.7,92.8-136.6c7.6-1.2,15.2-1.8,22.9-1.8h475.9c58.6,0,108.4,45.1,114.1,103.4C806.7,256.9,763.1,312.2,701.9,320.6z"/>
			</svg>
		</a>
	</li>
<% end_if %>